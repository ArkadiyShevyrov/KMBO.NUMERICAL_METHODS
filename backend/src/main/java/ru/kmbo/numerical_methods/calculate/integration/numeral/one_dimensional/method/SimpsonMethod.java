...
public class SimpsonMethod implements NumericalIntegrationMethod {
    ...
    private double bigSumEven(Function f, int iStart, int iEnd, Map<Integer, Double> xMap) {
        double sum = 0;
    ...
    private double bigSumOdd(Function f, int iStart, int iEnd, Map<Integer, Double> xMap) {
        double sum = 0;
        for (int i = iStart; i <= iEnd; i++) {
